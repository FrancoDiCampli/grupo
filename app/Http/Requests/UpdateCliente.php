...
class UpdateCliente extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'documentounico' => 'required|min:8|max:11|unique:clientes,documentounico,' . $this->cliente . ',id,deleted_at,NULL',
            'direccion' => 'required|min:1|max:190',
            'email' => 'required|email|unique:clientes,email,' . $this->cliente . ',id,deleted_at,NULL',
