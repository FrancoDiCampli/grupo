        ...
        total: {
            ...
            get() {
                if (this.subtotal) {
                    ...
                    if (this.$store.state.pedidos.form.bonificacion) {
                        bonificacion =
                            Number(
                                this.$store.state.pedidos.form.bonificacion *
                                    this.subtotal
                            ) / 100;
                    }

                    if (this.$store.state.pedidos.form.recargo) {
                        recargo =
                            Number(
                                this.$store.state.pedidos.form.recargo *
                                    this.subtotal
                            ) / 100;
                    }
        ...
        searchClienteAfter() {
            ...
            if (this.searchCliente != null && this.searchCliente != "") {
                if (this.searchCliente == "0") {
                    ...
                    this.$store.state.pedidos.form.cliente_id = 1;
                    this.clientes = [];
        ...
        setData: async function() {
            if (
                ...
                if (this.detalles.length <= 0) {
                    ...
                    this.$store.state.pedidos.form.subtotal = this.subtotal;
                    this.$store.state.pedidos.form.total = this.total;
                    this.$store.state.pedidos.form.totalPesos = this.totalPesos;
                    this.$store.state.pedidos.form.detalles = this.detalles;
