<template>
    <div>
        <v-card shaped outlined :loading="inProcess">
            ...
            <v-card-text class="pa-0 ma-0">
                <v-stepper v-model="step" vertical class="elevation-0">
                    ...
                    <v-stepper-step
                        ...
                        :rules="[() => validateStep(1, 'presupuestosClienteForm')]"
                            ...
                            <v-row justify="space-around" class="my-1">
                                ...
                                <v-col cols="12" sm="5" class="py-0">
                                    <v-dialog
                                        ...
                                        v-model="vencimiento"
                                        :return-value.sync="$store.state.presupuestos.form.vencimiento"
                                        persistent
                                        :width="$vuetify.breakpoint.xsOnly ? '100%' : '300px'"
                                    >
                                        <template v-slot:activator="{ on }">
                                            <v-text-field
                                                v-model="$store.state.presupuestos.form.vencimiento"
                                                label="Vencimiento"
                                                readonly
                                                outlined
                                                v-on="on"
                                        ...
                                        >
                                            ...
                                            <v-btn
                                                text
                                                color="primary"
                                                @click="$refs.dialogVencimiento.save($store.state.presupuestos.form.vencimiento)"
                                            >Aceptar</v-btn>
                                        </v-date-picker>
                                    </v-dialog>
                                </v-col>
                    ...
                    <v-stepper-step
                        ...
                        :editable="true"
                        edit-icon="fas fa-pen"
                        :rules="[() => validateStep(3, 'presupuestosTotalesForm')]"
                            ...
                            <v-row justify="space-around" class="my-1">
                                <v-col cols="12" sm="6" class="py-0 px-0">
                                    ...
                                    <v-col cols="12" class="py-0">
                                        <v-text-field
                                            v-model="
                                        $store.state.presupuestos.form.bonificacion
                                    "
                                            type="number"
                                            label="Bonificacion %"
                                            outlined
                                    ...
                                    <v-col cols="12" class="py-0">
                                        <v-text-field
                                            v-model="$store.state.presupuestos.form.recargo"
                                            type="number"
                                            label="Recargo %"
                                            outlined
                                        ></v-text-field>
                    ...
                    <v-stepper-content step="4">
                        <v-row justify="center" class="my-1">
                            <v-col cols="12" class="py-0">
                                <v-textarea
                                    v-model="$store.state.presupuestos.form.observaciones"
                                    outlined
                                    label="Observaciones"
                                    no-resize
                                ></v-textarea>
