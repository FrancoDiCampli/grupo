<template>
    <div>
        <div v-if="$store.state.ventas.venta" :loading="$store.state.inProcess">
                        ...
                        <v-row>
                            ...
                            <v-col cols="12" sm="6" class="header-left">
                                <h2 class="text-center">
                                    {{
                                    $store.state.ventas.venta.configuracion
                                    .nombrefantasia
                                    }}
                                </h2>
                                <p>
                            ...
                            <v-col cols="12" sm="6" class="header-right">
                                ...
                                <p>
                                    ...
                                    {{$store.state.ventas.venta.factura.comprobanteadherido}}
                                </p>
                                <p>
                            ...
                            <v-col cols="12" class="pre-body">
                                ...
                                <p>
                                    <b>CUIT:</b>
                                    {{
                                    $store.state.ventas.venta.cliente
                                    .documentounico
                                    }}
                                </p>
                                <p>
...
export default {
    ...
    methods: {
        getVenta: async function() {
            this.inProcess = true;
            await this.$store.dispatch("ventas/show", {
                id: this.id
            });
        ...
        print() {
            let id = this.$store.state.ventas.venta.factura.id;
