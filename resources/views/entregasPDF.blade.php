    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="header-right">
                <h2 class="center">REMITO ENTREGA</h2>
                <p><b>Punto de Venta: </b>0000{{$configuracion['puntoventa']}}<b> Comprobante adherido: </b>{{$entrega->numentrega}}</p>
                <p><b>Fecha de Emisión: </b>{{$entrega->fecha}}</p>
        ...
        <div class="footer">
            ...
            <p><b>Observaciones: </b>{{$entrega->observaciones}}</p>
            @endif
        </div>
    </div>
