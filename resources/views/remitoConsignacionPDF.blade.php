    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="header-right">
                ...
                <p><b>Punto de Venta: </b>0000{{$configuracion['puntoventa']}}<b> Comprobante Nº: </b>{{$consignacion->id}}</p>
                <p><b>Fecha de Emisión: </b>{{$consignacion->fecha}}</p>
        ...
        <div class="pre-body">
            ...
            <p><b>Condición de Venta: </b>{{$consignacion->tipo}}</p>
        </div>
        <br>
        <div class="body">
            <table>
        ...
        <div class="footer">
            <div class="details">
                ...
                <p><b>Fecha Cotización: </b>{{$consignacion->fechaCotizacion}}</p>
                ...
                <p><b>Bonificación: </b>{{$consignacion->bonificacion}}%</p>
