    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="header-right">
                <h2 class="center">REMITO DEVOLUCION</h2>
                <p><b>Punto de Venta: </b>0000{{$configuracion['puntoventa']}}<b> Comprobante Nº: </b>{{$devolucion->id}}</p>
                <p><b>Fecha de Emisión: </b>{{$devolucion->fecha}}</p>
        ...
        <div class="pre-body">
            <br>
            <p><b>CUIT: </b>0</p>
            <p><b>Razón Social: </b>{{$dependencia->name}}</p>
            <p><b>Condición Frente al IVA: </b>N/D</p>
            <p><b>Domicilio: </b>N/D</p>
            <p><b>Condición de Venta: </b>{{$devolucion->tipo}}</p>
        </div>
        <br>
        <div class="body">
            <table>
        ...
        <div class="footer">
            ...
            <p><b>Observaciones: </b>{{$devolucion->observaciones}}</p>
            @endif
            <div class="details">
                <p><b>Total: </b>USD {{$devolucion->total}}</p>
            </div>
        </div>
    </div>
